...
parser.add_argument("--dataset_name", type=str,
                    default="pseudomonas", help="name of the dataset")
...
G_BA = GeneratorResNet(input_shape, intermediate_dim,
                       output_dim, opt.n_residual_blocks)
D_A = Discriminator(input_shape, intermediate_dim, output_dim)
D_B = Discriminator(input_shape, intermediate_dim, output_dim)
